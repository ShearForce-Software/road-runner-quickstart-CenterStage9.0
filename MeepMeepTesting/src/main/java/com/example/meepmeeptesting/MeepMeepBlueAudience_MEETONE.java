...
public class MeepMeepBlueAudience_MEETONE {
    public static void main(String[] args) {
        ...
        myBot.runAction(myBot.getDrive().actionBuilder(new Pose2d(-36, 60, Math.toRadians(270)))
                ...
                .splineTo(new Vector2d(-36, 14), Math.toRadians(270))

                //Pause to deliver to spike mark 2
                //Rotate robot

                .setTangent(Math.toRadians(270))
                .splineTo(new Vector2d(-36, 7), Math.toRadians(270))
                ...
                .setReversed(true)
                .splineTo(new Vector2d(38, 10), Math.toRadians(0))
                .setReversed(false)
